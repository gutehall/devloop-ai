...
- Any obvious performance/security concerns?
- Is commit history logical and split meaningfully?

Output:
- Short checklist (pass/fail) with comments.
- List items to fix before PR.
